...
function (_Component) {
  ...
  _createClass(HierarchicalTermSelector, [{
    ...
    value: function renderTerms(renderedTerms) {
      ...
      return renderedTerms.map(function (term) {
        ...
        return React.createElement("div", {
          ...
          htmlFor: id
        }, (0, _lodash.unescape)(term.name)), !!term.children.length && React.createElement("div", {
    ...
    value: function render() {
      ...
      return [showFilter && React.createElement("label", {
        key: "filter-label",
        htmlFor: filterInputId
      }, filterLabel), showFilter && React.createElement("input", {
        type: "search",
        id: filterInputId,
        value: filterValue,
      ...
      }, this.renderTerms('' !== filterValue ? filteredTermsTree : availableTermsTree)), !loading && hasCreateAction && React.createElement(_components.Button, {
        key: "term-add-button",
        onClick: this.onToggleForm,
        className: "editor-post-taxonomies__hierarchical-terms-add",
        "aria-expanded": showForm,
        isLink: true
      }, newTermButtonLabel), showForm && React.createElement("form", {
        onSubmit: this.onAddTerm,
        key: klass + "-terms-form"
      }, React.createElement("label", {
        htmlFor: inputId,
        className: "editor-post-taxonomies__hierarchical-terms-label"
      }, newTermLabel), React.createElement("input", {
        type: "text",
        id: inputId,
        className: "editor-post-taxonomies__hierarchical-terms-input",
        value: formName,
        ...
        required: true
      }), taxonomy.hierarchical && !!availableTerms.length && React.createElement(_components.TreeSelect, {
