// Copied from gutenberg/packages/editor/src/components/post-taxonomies/hierarchical-term-selector.js
...
function buildTermsTree( flatTerms ) {
	...
	const termsByParent = lodash.groupBy( flatTermsWithParentAndChildren, 'parent' );
